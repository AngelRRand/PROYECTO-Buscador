...
/* datosBusqueda es un objeto que tiene llaves pero no valores  */
const datosBusqueda = {
    marca: '',
    year: '',
    minimo: '',
...
document.addEventListener('DOMContentLoaded', () =>{
    ...
    mostrarAutos(autos);      /* Muestra los automoviles al cagar */
...
function mostrarAutos(autos){
    ...
    autos.forEach(auto => {
        ...
        autoHTML.textContent = `
            ${marca} ${modelo} - Año: ${year} - Precio :${precio} - Puertas: ${puertas} - Color: ${color} - Trasmision: ${transmision}
...
/* Muestra un mensaje si no existe resultado en la busqueda */
function noResultado(){
    ...
    noResultado.textContent = 'No se encontro resultados'
